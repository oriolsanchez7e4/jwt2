...
import com.example.jwt.seguretat.jwt.ElMeuAuthenticationEntryPoint;
import com.example.jwt.seguretat.jwt.JWTAuthorizationFilter;
...
//    @Override
    ...
    "Oriol", "1234" comença en majúscula
     */
...
//                .and()
                ...
                .antMatchers(HttpMethod.GET, "/login/**","/usuaris/**", "/employee/**").hasRole("USER")
